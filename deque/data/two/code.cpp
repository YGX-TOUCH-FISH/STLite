...
bool isEqual(Ans &ans, Test &test) {
    ...
    if (ans.empty() != test.empty() || ans.front() != test.front() ||
        ans.back() != test.back())
    {
//        if (ans.empty()) std::cout << "ans_is_empty\n";
//        else std::cout << "ans_isnot_empty\n";
//        if (test.empty()) std::cout << "test_is_empty\n";
//        else std::cout << "test_isnot_empty\n";
//        if (ans.front() != test.front()) std::cout << 1<<'\n';
//        if (ans.back() != test.back()) std::cout << 2<<'\n';
        return false;
    }
